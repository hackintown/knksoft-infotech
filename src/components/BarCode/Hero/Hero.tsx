...
export default function Hero() {
  ...
  const imageSlide = [
    "https://www.signitysolutions.com/hs-fs/hubfs/Group%20578.png?width=745&height=540&name=Group%20578.png",
  ];
          ...
          >
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-base font-thin lg:text-lg text-foreground">
                Transform your business with our advanced barcode technology. Streamline operations, enhance accuracy, and boost productivity.
              </p>
            </div>
