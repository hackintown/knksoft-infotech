    ...
    >
      <header className="bg-white dark:bg-gray-800 shadow-md sticky top-0 z-10 backdrop-blur-md bg-opacity-90 dark:bg-opacity-90">
        <div className="max-w-7xl mx-auto px-4 py-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          >
            <IoMdArrowBack className="w-6 h-6 sm:w-8 sm:h-8" />
          </Link>
          <div className="flex space-x-4">
            ...
            <button className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 transition-colors">
              <FaEllipsisV className="w-6 h-6 sm:w-7 sm:h-7" />
            </button>
          </div>
        </div>
      </header>
      ...
      <main className="max-w-5xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        <article className="bg-white dark:bg-gray-800 shadow-2xl rounded-2xl overflow-hidden">
          <motion.div
