    ...
    <section className="hero-gradient min-h-screen pt-24 pb-12 px-4 w-full relative overflow-hidden">
      ...
      >
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div variants={itemVariants} className="space-y-8">
            <motion.div className="space-y-6">
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                Leveraging cutting-edge technology to deliver scalable, secure, and 
                innovative solutions for enterprise digital transformation.
              </motion.p>
            ...
            >
              {[
                { icon: FiCloud, title: 'Cloud Solutions', desc: 'Scalable infrastructure' },
                { icon: FiShield, title: 'Cyber Security', desc: 'Enterprise protection' },
                { icon: FiDatabase, title: 'Data Analytics', desc: 'Intelligent insights' },
                { icon: FiAward, title: 'AI Integration', desc: 'Smart automation' },
              ].map((feature, index) => (
                <div key={index} className="p-4 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10 hover:border-primary/30 transition-all">
          ...
          <motion.div variants={itemVariants} className="space-y-8 hidden lg:block">
