...
export default function Hero() {
  ...
  const imageSlide = [
    "https://cdn-hjokj.nitrocdn.com/xKvPrJeRKcMfBVHKpjbxbYMvqmxtHXge/assets/images/optimized/rev-6ddbe2e/d3l9a8mvoa6cl8.cloudfront.net/wp-content/uploads/sites/5/2023/05/17102655/taxi-bnr.png",
  ];
