...
const BeautyMarketplace = () => {
  const features = [
    {
      icon: <MenuSquare className="w-6 h-6 text-[#ff4d4d]" />,
      title: "Booking and Scheduling",
      description: "Easy appointment management system",
    },
    {
      icon: <Users className="w-6 h-6 text-[#ff4d4d]" />,
      title: "Service Variety and Customization",
      description: "Wide range of beauty services",
    },
    {
      icon: <Bell className="w-6 h-6 text-[#ff4d4d]" />,
      title: "Customer Support Integration",
      description: "24/7 assistance and help",
    },
    {
    ...
    },
    {
      ...
      description: "Easy service discovery",
    },
  ];
    ...
    <section className="container px-4 py-6 lg:py-10">
      <div className="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
        ...
        <div className="w-full lg:w-1/2">
          ...
          >
            On-Demand Beauty Marketplace App
          </motion.h3>
          ...
          >
            Connect users and salon and professionals for various services like
            hair styling, makeup and skincare with our beauty app development
            solutions.
          </motion.p>
        ...
        >
          <Image
            src="https://www.valueappz.com/images/on-demand-beauty-marketplace.png"
...
export default BeautyMarketplace;
