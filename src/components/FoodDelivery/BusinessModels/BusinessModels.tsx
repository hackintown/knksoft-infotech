...
import { FaUtensils, FaStore, FaBuilding, FaDollarSign, FaHandshake, FaRocket } from 'react-icons/fa';
    ...
    const steps = [
        {
            ...
            description: "Take your business online and grow with our comprehensive ordering and delivery apps.",
            isUp: true
        },
        {
            id: 2,
            ...
            description: "Build a food delivery app like Doordash, Grubhub, Zomato by aggregating local businesses.",
            isUp: false
        },
        {
            id: 3,
            ...
            description: "Manage online orders and delivery for all your franchises and chain stores through a single dashboard.",
            isUp: true
        },
        {
            id: 4,
            ...
            description: "Create a food delivery app to promote your unique food idea and brand.",
            isUp: false
        }
    ];
        ...
        <section className="py-10 px-4 container">
            <div className="text-center mb-16">
                ...
                <p className="text-gray-600 text-lg">
                    Whether you need an app for your restaurant or want to start your food marketplace like Uber Eats, we've got you covered!
                </p>
            </div>
