...
export default function Hero() {
    ...
    const imageSlide = [
        "https://www.signitysolutions.com/hs-fs/hubfs/Group%20627.png?width=644&height=464&name=Group%20627.png",
        "https://www.signitysolutions.com/hs-fs/hubfs/Group%20627.png?width=644&height=464&name=Group%20627.png"
    ];
                        ...
                        <div className="space-y-4">
                            ...
                            >
                                <span className="text-sm font-medium text-primary">
                                    From Concept to MVP in Weeks, Not Months
                                </span>
                            </motion.div>
                            ...
                            <p className="max-w-2xl text-base font-thin lg:text-lg text-foreground">
                                Transform your vision into a market-ready MVP with our rapid development approach.
                                We focus on core features, user feedback, and iterative improvements to help you
                                validate your business idea quickly and cost-effectively.
                            </p>
                        </div>
