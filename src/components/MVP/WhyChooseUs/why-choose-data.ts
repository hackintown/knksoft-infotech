...
export const whyChooseData: WhyChooseUsData = {
  ...
  imageSrc:
    "https://cdn-hjokj.nitrocdn.com/xKvPrJeRKcMfBVHKpjbxbYMvqmxtHXge/assets/images/optimized/rev-47d43d1/d3l9a8mvoa6cl8.cloudfront.net/wp-content/uploads/2023/06/30185457/hm_whychs-new.png", // Replace with your actual image path
  features: [
    {
      id: "quality",
      title: "Quality",
